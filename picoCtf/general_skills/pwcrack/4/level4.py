...
# secret key will be resize to the same lens, then will be set into a pair like {secret[i], key[i]}
# and xor each pos in the pair list to get a final key
# this is the decode func
...
def level_4_pw_check():
    ...
    # after md5 the given pwd, compare it with the correct pwd, if equal, use the decode func to decrpt the flag
